...
// Split out of app/(marketing)/location/page.tsx so that file can be a
// plain Server Component exporting real per-page metadata — a "use client"
// page.tsx can't export `metadata`/`generateMetadata` at all.
        ...
        <div className="max-w-container-max mx-auto grid grid-cols-1 lg:grid-cols-12 gap-space-xl">
          ...
          <div className="lg:col-span-6 flex flex-col gap-space-2xl">
            ...
            <div id="inquiry" className="loc-card-anim bg-surface-container p-space-xl shadow-hard border border-surface-variant/40 scroll-mt-24">
              ...
              <h2 className="font-headline-sm text-headline-sm uppercase text-on-surface mb-space-md">
