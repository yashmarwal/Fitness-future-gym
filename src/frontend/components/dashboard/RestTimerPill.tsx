...
// of where the countdown was actually started. Hidden once the countdown
// finishes: RestTimerAlarmWatcher's full-screen popup takes over from there.
export default function RestTimerPill() {
  ...
  return (
    <Link
      ...
      className="inline-flex items-center gap-2 rounded-full bg-primary-container text-on-primary-container pl-2.5 pr-3.5 py-1.5 shadow-soft hover:bg-secondary-container transition-colors"
    >
