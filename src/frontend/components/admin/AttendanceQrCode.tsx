...
export default function AttendanceQrCode() {
  ...
  return (
    <div className="flex flex-col gap-6 max-w-md">
      ...
      {dataUrl && (
        <div className="bg-surface-container-lowest p-6 shadow-hard flex flex-col items-center gap-4">
          {/* eslint-disable-next-line @next/next/no-img-element -- data: URL, next/image can't optimize it */}
          <img src={dataUrl} alt="Attendance check-in QR code" className="w-64 h-64" />
