  ...
  return (
    ...
    >
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@24,400,0,0&icon_names=accessibility_new,add,add_circle,add_task,arrow_back,arrow_forward,auto_awesome,autorenew,badge,block,bolt,cake,calculate,calendar_month,call,campaign,check,check_box,check_circle,chevron_left,chevron_right,close,construction,dashboard,delete,directions_run,diversity_3,download,edit,edit_note,emoji_events,error,event_available,event_busy,event_note,expand_less,expand_more,fitness_center,format_quote,group,home,hourglass_top,info,ios_share,local_fire_department,location_on,lock,lock_open,logout,menu,military_tech,monitor_heart,navigation,notifications,notifications_active,notifications_off,pause,payments,person,person_add,person_off,pin_drop,play_arrow,precision_manufacturing,qr_code_2,qr_code_scanner,refresh,remove,repeat,restart_alt,restaurant,rowing,schedule,search,self_improvement,shield,smart_toy,sports_gymnastics,sports_kabaddi,sports_martial_arts,stars,sticky_note_2,stop,storefront,timelapse,timer,today,verified,view_compact,volume_off,volume_up,warning,water_drop,workspace_premium&display=swap"
          rel="stylesheet"
        />
